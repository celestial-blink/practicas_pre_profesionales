...
use crate::modules::ofertas::domain::{
    dtos::{search_params::SearchParams, oferta_with_niveles::OfertaWithNivelesDto},
    oferta::Oferta,
};

pub trait OfertaRepository {
    async fn create_with_niveles(&self, oferta: Oferta, tx: &mut Transaction<'_, sqlx::MySql>) -> Result<i32, String>;
    async fn update(&self, oferta: Oferta, tx: &mut Transaction<'_, sqlx::MySql>) -> Result<(), String>;
